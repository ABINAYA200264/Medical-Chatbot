# 🩺 Medical Chatbot – GenAI Healthcare Assistant  
...
- Understanding user symptoms/questions  
- Generating medically relevant responses  
...
- High-quality biomedical & clinical knowledge  
- Safety-optimized responses  
- Context-aware reasoning  
- Suitable for medical Q&A use cases  
...
- Biomistral API integration  
- Prompt engineering for safe medical Q&A  
...
- **Google Colab**
- **Biomistral LLM API**
- **Requests / Python client libraries**
...
2. Install required dependencies (included inside the notebook)  
3. Add your **Biomistral API key** in the specified cell  
4. Run all cells  
...
- **GIVI Connected GenAI Program** for learning support  
